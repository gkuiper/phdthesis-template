	...
	{%
		...
		\begin{tabular}{@{}>{\Centering\arraybackslash\figureversion{text,prop}}m{\logowd}%
			...
			\begin{minipage}{\descrwd}%
				\href{http://www.utwente.nl/}{\includegraphics[width=0.75\linewidth]{figures/ut_logo}} \\[1em]
				Faculty of \acl*{EWI},
				\href{http://caes.ewi.utwente.nl/}{\acf*{CAES}} group
			\end{minipage} \\
			& \\
% 			\raisebox{-.5ex}{\href{http://www.utwente.nl/ctit}{\includegraphics[width=\logowd]{figures/ctit_logo}}} & %
			& %
			\begin{minipage}[c]{\descrwd}%
				\acs*{IDS} Ph.D.\ Thesis Series No.\ \thesisIDSnr \\
				\acl*{IDS} \\
				PO Box 217, 7500 AE {} Enschede, The Netherlands
			\end{minipage} \\
			&\\
%			\includegraphics[width=\logowd]{figures/nest_logo}
			\href{http://www.stw.nl/}{\includegraphics[width=\logowd]{figures/stw_logo}} & %
			\begin{minipage}[c]{\descrwd}%
			...
			\begin{tikzpicture}[
				...
				\node[logo,anchor=270] at (0,0) {\includegraphics[width=.34\logowd]{figures/cc}};
				\node[logo,anchor=30]  at (0,0) {\includegraphics[width=.34\logowd]{figures/by}};
				\node[logo,anchor=150] at (0,0) {\includegraphics[width=.34\logowd]{figures/nc}};% or use nc-eu for euro symbol
			\end{tikzpicture}%
			\end{minipage}%
			& %
			\begin{minipage}[c]{\descrwd}%
...
%				\draw[red,thick,|<->|] (0,.5\pgflinewidth) to node[sloped,anchor=south,font=\footnotesize] {$\ge$\SI{12}{\milli\meter}} ($(0,12mm)+(0,-.5\pgflinewidth)$);}%
			...
			{\href{http://www.fsc.nl/}{\includegraphics[height=12.2mm]{figures/FSC_Gildeprint}}}}%
			& %
			\begin{minipage}{\descrwd}%
			...
			& \begin{minipage}{\descrwd}%
				...
				\noac{ISSN} & \href{http://opc4.kb.nl/DB=1/SET=2/TTL=1/CMD?ACT=SRCHA&IKT=1007&SRT=YOP&TRM=\thesisISSN}{\thesisISSN}; %
					\acs*{CTIT} Ph.D.\ Thesis Series No.\ \thesisIDSnr \\
