...
\newacronym[user1={test}]{DVI}{DVI}{digital visual interface}
...
\newacronym[type=nolist]{IDS}{IDS}{Institute on Digital Society}
...
\newcommand{\resetacr}{
	\glsresetall
    %\glsunsetall[\acronymtype]%enable to not display long (short) for first use
}
\resetacr
